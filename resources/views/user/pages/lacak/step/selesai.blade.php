<div class="form-group row">
    <div class="col-xl-4 col-md-3">
        <div class="row">
            <div class="col btn btn-brown">
                Sistem
            </div>
        </div>
    </div>
    <div class="col-xl-8 col-md-9">
        Barang bukti telah diambil. Peminjaman telah selesai.
    </div>
</div>
<hr>
<div class="form-group row">
    ...
    <div class="col-xl-8 col-md-9">
        Pengajuan Anda telah disetujui oleh Jaksa. <br> {{$peminjaman->keterangan_peminjaman ?? '-'}}
    </div>
</div>
<hr>
<div class="form-group row">
