...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center mb-3 mt-4">
        <h1 class="h3 text-black">Ubah Data Jaksa</h1>
    </div>
                ...
                <div class="card-body">
                    ...
                    @method('patch')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control @error('nrp_jaksa') is-invalid @enderror" name="nrp_jaksa" id="nrp_jaksa" placeholder="Masukan NRP"value="{{ $jaksa->nrp_jaksa }}" readonly>
